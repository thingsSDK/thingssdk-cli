...
describe("thingssdk new", () => {
  ...
  */
  ...
  xdescribe("function applicationFinished()", () => {});
  xdescribe("function createFiles()", () => {});
  xdescribe("function copy()", () => {});
  xdescribe("function write()", () => {});
  xdescribe("function createPackageJSON()", () => {});
  xdescribe("function clearLine()", () => {});
  xdescribe("function printLoading()", () => {});
  xdescribe("function getPorts()", () => {});
  xdescribe("function createDevicesJSON()", () => {});
})
